...
#define PHY_SR    ((uint16_t)31) /* Value for LAN8720A PHY */
...
#define PHY_SPEED_STATUS            ((uint16_t)0x0004) /* Value for DP83848 PHY */
#define PHY_DUPLEX_STATUS           ((uint16_t)0x0010) /* Value for LAN8720A PHY */
